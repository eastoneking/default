 ...
 * Type:eastone.component.http.simple.HttpMethodEnum
 */
...
public enum HttpMethodEnum {
	 ...
	 *  passes through a series of proxy servers. The recipient of a TRACE
	 *  method echoes the HTTP request headers back to the client.
	 */
	TRACE,

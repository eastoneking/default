/*
 * File:SQLExecutor.java Type:eastone.component.database.SQLExecutor
 */
 ...
 * SQL执行接口.
 * <p>
 * 接口用于执行SQL.因为考虑兼容myBatis方式,所以方法命名没有完全依照SQL的习惯.
 * </p>
 * <p>
 * <ol>
 * <li>初始版本,wangds@gmail.com,2013-10-16 下午10:21:48</li>
 * <li>根据check style修改格式, by wangds@gmail.com, 2013-10-27 15:07</li>
 * </ol>
 * </p>
...
public interface SQLExecutor<S, R, E extends Exception> extends Processor<E>,
   ...
   * 设置要执行SQL文本.
   * <p>
   * 对于JDBC,是SQL语句;对于MyBatis等,是用来唯一标识SQL的ID.
   * </p>
   ...
   * @param <T> 参数类型.
   *          <p>
   *          JDBC接口时,T类型应该为"Object[]".
   *          </p>
   * @param parameters 参数值.
   */
  <T> void setParameters(T parameters);

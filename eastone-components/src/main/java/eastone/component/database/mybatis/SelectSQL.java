/*
 * File:SelectSQL.java Type:eastone.component.database.mybatis.SelectSQL
 */
...
public class SelectSQL<R> extends MyBatisSQLExecutor<Collection<R>> {
  ...
  @Override
  protected final Collection<R> executeOperation(final SqlSession session,
      final String commandText, final Object parameters) {

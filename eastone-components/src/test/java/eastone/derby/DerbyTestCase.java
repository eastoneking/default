/*
 * File:DerbyTestCase.java
 * Type:eastone.derby.DerbyTestCase
 */
...
public class DerbyTestCase extends TestCase {
	...
	public static void testInitConnectAndShutdownDerbyDB() {
		...
		connect = null;
		try {
			String shutdown_url = "jdbc:derby:" + dbName + ";shutdown=true";
			connect = DriverManager.getConnection(shutdown_url);
		} catch (SQLException e) {

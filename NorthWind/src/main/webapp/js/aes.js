...
var iv =  CryptoJS.enc.Hex.parse('1000dee1817259c0d473ae537b721e8b')
   ...
   /*  var encrypted = {};
    ...
    encrypted.s="7f562f709f2db529";
    var decrypted = CryptoJS.DES.decrypt(encrypted, "12345678", { format: JsonFormatter, mode: CryptoJS.mode.CFB, padding: CryptoJS.pad.AnsiX923});

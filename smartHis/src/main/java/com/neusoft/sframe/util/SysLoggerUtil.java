...
public class SysLoggerUtil {
	...
	public static void saveLogToFile(UserBean user, String url,
			String ip, String paramStr, long handleTime,String userAgent) {
		//log.info("url:" + url +"|ip:"+ ip + "|userId:"+ user.getUserId() +"|userAgent:"+ userAgent + "|handleTime:" + handleTime  +"|params:"+ paramStr);
		//这个是用来调试的
		log.info("url:" + url +"|ip:"+ ip +"|userAgent:"+ userAgent + "|handleTime:"+ handleTime  +"|params:"+ paramStr);
	}
}

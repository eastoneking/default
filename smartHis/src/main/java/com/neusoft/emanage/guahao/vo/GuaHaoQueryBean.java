package com.neusoft.emanage.guahao.vo;
 ...
 * 
 */
public class GuaHaoQueryBean extends EasyUiBaseBean  {
	 ...
	 * 挂号科室名字
	 */
	private String sel_ghkeshiname;
	/**
	 * 挂号类别
	 */
	...
	public String getSel_ghnumber() {
		return sel_ghnumber;
	}
	public void setSel_ghnumber(String sel_ghnumber) {
		this.sel_ghnumber = sel_ghnumber;
	}
	public String getSel_ghkeshiname() {
		return sel_ghkeshiname;
	}
	public void setSel_ghkeshiname(String sel_ghkeshiname) {
		this.sel_ghkeshiname = sel_ghkeshiname;
	}
}

...
/*************************************************鲁凯添加开始*************************************************************/
/************************修改easyui的alert提示框默认close的绑定事件，将调用alert方法是提供的方法参数绑定到close按钮上********************************/
var closedbutton = win.parent().children("div.panel-header").children("div.panel-tool").children("a.panel-tool-close");
closedbutton.unbind("click");
closedbutton.bind("click",function(){
	win.window("close");
	if(fn){
	fn();
	return false;

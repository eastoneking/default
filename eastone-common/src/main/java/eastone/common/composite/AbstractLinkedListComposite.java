 ...
 *
 */
public abstract class AbstractLinkedListComposite<C extends Component>
	extends GeneralParentObject
	implements Composite<C, Integer> {
	...
	@Override
	public <T extends C> void add(T component) {
		this.components.add(component);
	}

	@Override
	public <T extends C> void remove(T component) {
	...
	@Override
	public <T extends C> T getComponent(Integer identity) {
		T res = null;

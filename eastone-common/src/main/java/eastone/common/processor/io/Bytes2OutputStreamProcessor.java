 ...
 * <p>修改记录:
 * <ol>
 * 	<li>补充注释,by wangds@gmail.com,2013-10-13 22:58.</li>
 * 	<li>增加偏移量和长度的支持,by wangds@gmail.com,2013-10-13 23:08.</li>
 * 	<li>增加实现接口{@link Clearable}, by wangds@gmail.com,2013-10-16 08:00.</li>
 * </ol>
 * </p>
...
public class Bytes2OutputStreamProcessor extends eastone.common.Object implements Processor<IOException>,Clearable{
	...
	/**
	 * 计算输出长度.
	 * <p>为了防止输出越界,会根据已经计算获得的偏移量和输出数据的大小,确定能够输出数
	 * 据的范围,并依据这个范围对输出长度进行计算.</p>
	 * <p>
	 * 处理过程:
	 * <pre>
	 *                ●
	...
	/**
	 * 计算偏移量.
	 * <p>偏移量即实际输出数据在给定数据属性{@link #data}中开始位置的坐标.</p>
	 * <p>
	 * 处理过程:<br/>
	 * <pre>
	 *               ●
	 ...
	 * <p>最大值为属性{@link #data}的byte数组的长度.</p>
	 * @return 实际输出时的偏移量.
	 */
	 ...
	 * 	<tr><th>{@link #data}</th><td>byte[0]</td></tr>
	 * 	<tr><th>{@link #offset}</th><td>0</td></tr>
	 * <tr><th>{@link #length}</th><td>-1</td></tr>
	 * <tr><th>{@link #outputStream}</th><td>null</td></tr>
	 * </table>.
	 * </p>
	 */
	@Override

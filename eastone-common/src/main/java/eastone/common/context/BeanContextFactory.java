 ...
 * @modifyList
 * <ol>
 * 		<li>2013-10-12 22:43 确定版本,补充注释.</li>
 * 		<li>2013-10-12 23:04 
	 * 		<ul>
	 * 			<li>一个工厂类只能产生单例的BeanContext;</li>
	 * 			<li>添加静态工厂方法{@link #getBeanContext()}，使用此方法永远只能
	 * 获得同一单例上下文.</li>
	 * 		</ul>
 * 		</li>
 * </ol>
...
public class BeanContextFactory implements Factory<BeanContext, RuntimeException>{
	...
	/**
	 * 生成实例时的锁对象.
	 * <p>因为对<code>java.util.concurrent</code>不熟悉，暂时使用synchronized方式控制
	 * 同步.是否更改待议.</p>
	 */
	 ...
	 * <p>通过Service-Provider方式获得接口实例.通过
